...
class SuezMedicalComplexConfigurator(object):
    class Home:
        ...
        def return_Beds_occupancy_rate_info(parsed_data: dict) -> str:
            return (
                f" معدل اشغال الاسره : {int(float(parsed_data['Beds_Occupancy_Rate']))} في المائة\n"
            )
        @staticmethod
        ...
        def transformer_on_info(parsed_data: dict) -> str:
            return (
                f"غدد المحولات العامله: {int(float(parsed_data['transformer_on']))} مرات\n"
            )
        ...
        @staticmethod
        def main_return_temp_info(parsed_data: dict) -> str:
            return (
                f"درجة حرارة العائد الرئيسيه من المبرد: {float(parsed_data['main_return_temp'])} درجة مئوية\n"
            )

        @staticmethod
        def main_supply_tempv(parsed_data: dict) -> str:
            return (
        ...
        @staticmethod
        def chiller3_maintenance_hour_infos(parsed_data: dict) -> str:
            return (
...
#new ubdate
       ...
       # @staticmethod
        #def daily_index(parsed_data: dict) -> str:
            return (
                f"عدد المؤشر اليومي: {float(parsed_data['daily_index'])} \n"
            )

       # @staticmethod
        #def yearly_index(parsed_data: dict) -> str:
            return (
                f"عدد المؤشر السنوي: {float(parsed_data['yearly_index'])} \n"
            )

       # @staticmethod
        #def monthly_index(parsed_data: dict) -> str:
            return (
                f"عدد المؤشر الشهري: {float(parsed_data['monthly_index'])} \n"
            )

        #@staticmethod
        #def random_MVSG_2_energy(parsed_data: dict) -> str:
            return (
        ...
        #@staticmethod
        #def updated_at(parsed_data: dict) -> str:
            return (
        ...
        @staticmethod
        def Emergency_Beds_used_monthlyv(parsed_data: dict) -> str:
            return (
        ...
        def return_complex_report_info(parsed_data: dict) -> str:
            ...
            report += SuezMedicalComplexConfigurator.Home.return_Mask_Policy_Violations_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_Social_Distance_Violations_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_NuOF_Detected_Falls_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_transformer_on_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_transformer_Off_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_generator_on_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_generator_off_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_Elevator_on_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthly_total_cost_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_HVAC_alarm_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_medical_gas_alarm_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_fire_fighting_alarm_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_transformer_alarm_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_elevator_alarm_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_F_AHU_ON_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_F_AHU_OFF_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller_on_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller_off_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_MVSG_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_vaccum_press_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_air_4bar_press_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_air_7bar_press_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_oxygen_press_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_MVSG_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_MVSG_incoming2_energy_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_MVSG_incoming3_energy_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_Hospital_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_Clinics_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_Utilities_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_ele_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_chillers_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_AHU_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailyenergy_Boilers_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_MVSG_incoming2_energy_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_MVSG_incoming3_energy_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_Hospital_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_Clinics_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_Utilities_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_ele_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chillers_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_AHU_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_Boilers_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_dailycost_sg_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_yearlyenergy_MVSG_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_yearlycost_sg_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlycost_g_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlycost_f_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlycost_s_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlycost_th_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlycost_roof_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlycost_Hospital_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlycost_clinic_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlycost_Utilities_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_daily_water_consumption_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthly_water_consumption_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_daily_water_cost_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_yearly_water_consumption_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_yearly_water_cost_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_daily_oxygen_consumption_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthly_oxygen_consumption_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_daily_oxygen_cost_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_yearly_oxygen_consumption_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_yearly_oxygen_cost_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_status_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_engine_runtime_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_solar_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_last_op_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_bv_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_volt_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_curr_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_energy_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_object_feed1_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_object_feed2_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_object_feed3_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_rated_feed_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen1_estimated_feed_time_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller1_status_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller1_supply_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller1_return_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller2_status_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller2_supply_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller2_return_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller3_status_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller3_supply_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller3_return_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller4_status_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller4_supply_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller4_return_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chillers_op_hours_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller1_op_hours_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller2_op_hours_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller3_op_hours_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller4_op_hours_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chiller1_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chiller2_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chiller3_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chiller4_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_in_Patients_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_out_Patients_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chillers_sys_operation_cost_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_main_return_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_main_supply_temp_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller1_maintenance_hours_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller2_maintenance_hours_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller3_maintenance_hours_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_chiller4_maintenance_hours_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_daily_index_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_yearly_index_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthly_index_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_random_MVSG_2_energy_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_random_MVSG_3_energy_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_updated_at_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen2_status_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen2_curr_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen2_energy_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen2_object_feed1_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen2_object_feed2_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen2_object_feed3_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_gen2_estimated_feed_time_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_air_4bar_percentage_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_air_7bar_percentage_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_vaccum_percentage_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_oxygen_percentage_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_no_of_surgry_month_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_no_of_dialysis_month_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_no_of_xrays_month_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_Inpatient_Beds_used_monthly_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_Inpatient_Beds_unused_monthly_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_ICU_CCU_Beds_used_monthly_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_ICU_CCU_Beds_unused_monthly_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_Emergency_Beds_used_monthly_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_Emergency_Beds_unused_monthly_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_Incubators_Beds_unused_monthly_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_Incubators_Beds_used_monthly_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_no_of_pepole_cam1_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_no_of_pepole_cam2_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_no_of_pepole_cam3_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_no_of_pepole_cam4_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_daily_carbon_foot_print_info(parsed_data)
            report += SuezMedicalComplexConfigurator.Home.return_monthly_carbon_foot_print_info(parsed_data)
        ...
        def return_station_report(parsed_data: dict) -> str:
            report =(
                ...
                SuezMedicalComplexConfigurator.Home.return_Mask_Policy_Violations_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_Social_Distance_Violations_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_NuOF_Detected_Falls_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_transformer_on_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_transformer_Off_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_generator_on_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_generator_off_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_Elevator_on_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthly_total_cost_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_HVAC_alarm_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_medical_gas_alarm_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_fire_fighting_alarm_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_transformer_alarm_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_elevator_alarm_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_F_AHU_ON_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_F_AHU_OFF_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller_on_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller_off_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_MVSG_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_vaccum_press_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_air_4bar_press_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_air_7bar_press_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_oxygen_press_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_MVSG_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_MVSG_incoming2_energy_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_MVSG_incoming3_energy_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_Hospital_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_Clinics_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_Utilities_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_ele_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_chillers_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_AHU_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailyenergy_Boilers_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_MVSG_incoming2_energy_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_MVSG_incoming3_energy_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_Hospital_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_Clinics_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_Utilities_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_ele_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chillers_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_AHU_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_Boilers_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_dailycost_sg_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_yearlyenergy_MVSG_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_yearlycost_sg_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlycost_g_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlycost_f_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlycost_s_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlycost_th_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlycost_roof_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlycost_Hospital_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlycost_clinic_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlycost_Utilities_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_daily_water_consumption_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthly_water_consumption_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_daily_water_cost_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_yearly_water_consumption_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_yearly_water_cost_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_daily_oxygen_consumption_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthly_oxygen_consumption_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_daily_oxygen_cost_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_yearly_oxygen_consumption_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_yearly_oxygen_cost_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_status_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_engine_runtime_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_solar_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_last_op_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_bv_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_volt_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_curr_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_energy_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_object_feed1_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_object_feed2_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_object_feed3_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_rated_feed_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen1_estimated_feed_time_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller1_status_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller1_supply_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller1_return_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller2_status_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller2_supply_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller2_return_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller3_status_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller3_supply_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller3_return_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller4_status_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller4_supply_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller4_return_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chillers_op_hours_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller1_op_hours_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller2_op_hours_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller3_op_hours_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller4_op_hours_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chiller1_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chiller2_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chiller3_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthlyenergy_chiller4_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_in_Patients_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_out_Patients_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chillers_sys_operation_cost_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_main_return_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_main_supply_temp_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller1_maintenance_hours_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller2_maintenance_hours_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller3_maintenance_hours_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_chiller4_maintenance_hours_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_daily_index_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_yearly_index_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_monthly_index_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_random_MVSG_2_energy_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_random_MVSG_3_energy_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_updated_at_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen2_status_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen2_engine_runtime_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen2_solar_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen2_last_op_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_index_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen2_bv_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen2_volt_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen2_curr_info(parsed_data) +
                SuezMedicalComplexConfigurator.Home.return_gen2_energy_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_gen2_object_feed1_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_gen2_object_feed2_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_gen2_object_feed3_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_gen2_estimated_feed_time_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_air_4bar_percentage_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_air_7bar_percentage_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_vaccum_percentage_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_oxygen_percentage_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_no_of_surgry_month_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_no_of_dialysis_month_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_no_of_xrays_month_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_Inpatient_Beds_used_monthly_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_Inpatient_Beds_unused_monthly_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_ICU_CCU_Beds_used_monthly_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_ICU_CCU_Beds_unused_monthly_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_Emergency_Beds_used_monthly_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_Emergency_Beds_unused_monthly_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_Incubators_Beds_unused_monthly_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_Incubators_Beds_used_monthly_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_no_of_pepole_cam1_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_no_of_pepole_cam2_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_no_of_pepole_cam3_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_no_of_pepole_cam4_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_daily_carbon_foot_print_info(parsed_data)+
                SuezMedicalComplexConfigurator.Home.return_monthly_carbon_foot_print_info(parsed_data)
